...
const CardGrid = () => {
  return (
    <div class="grid mb-8 border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 md:mb-12 md:grid-cols-2 bg-white dark:bg-gray-800 sm:mt-6">
    <figure class="flex flex-col items-center justify-center p-8 text-center bg-white border-b border-gray-200 rounded-t-lg md:rounded-t-none md:rounded-ss-lg md:border-e dark:bg-gray-800 dark:border-gray-700">
        ...
        <figcaption class="flex items-center justify-center ">
            <Image width={50} height={50} class="rounded-full w-9 h-9" src="/image/lighting.svg" alt="profile picture" />
